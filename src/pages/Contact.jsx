      ...
      <section className="py-24 bg-[#F8FAFC]">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <h2 className="text-5xl font-bold text-[#0B1120]">
          ...
          >
            ...
            <form className="space-y-6 mt-10">
              ...
              <button className="w-full bg-blue-600 hover:bg-yellow-400 hover:text-black duration-300 text-white py-4 rounded-xl font-semibold">
